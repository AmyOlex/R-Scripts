---
title: "Initial Gene Expression Analysis of RNA-Seq V2 RSEM TCGA Data for Selected Genes, Tumor Samples Only"
author: "Amy Olex"
date: "change date"
output: 
  html_document:
...
We are studying Genes associated with **INSERT PATHWAY AND CANCER** cancer in RNASeqV2 gene expression data from TCGA.  The RNASeq data was obtained via the Illumina HiSeq platform.  This report contains the analysis of tumor samples only and does not include normals.

Methods
---------

- I parsed the RNASeqV2 raw_counts data for all COAD patients using my tcgaRC.R class.
...
- I used only the tumor samples for this analysis
...
file <- "/Users/alolex/Desktop/CCTR/Data/KazuakiTakabe_S1P_0714_TCGA/TCGA Analyses/RNAseq_PAAD_all_111914/normalization/paad_111914_tumorOnlySamplesNormalized_n179.RData"
...
color_legend = revalue(levels(my_fact), c("MALE"="blue","FEMALE"="pink"))
fact_name="gender"
